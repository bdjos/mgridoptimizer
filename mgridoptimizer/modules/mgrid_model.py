    ...
    def io(self, amt):
        ...
        for battery in self.battery_list:
            ...
            if self.battery_list[battery]['mode'] == 'ss':
                ...
                charge = self.check_solar_support(battery['object'], amt)
...
class Solar():
    ...
    @classmethod
    def run_api(cls, system_capacity, base_cost, perw_cost, output_format='json',
                api_key='NueBIZfkmWJUjd7MK5LRrIi7MhFL2LLuRlZswFcM',
